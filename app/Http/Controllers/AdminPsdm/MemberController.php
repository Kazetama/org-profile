...
use App\Http\Requests\AdminPsdm\MemberRequest;
use Inertia\Inertia;
...
class MemberController extends Controller
{
    ...
    {
        return Inertia::render('admin-psdm/members/index', [
    ...
    {
        return Inertia::render('admin-psdm/members/create');
    }
    ...
    public function store(MemberRequest $request)
    {
        ...
        return redirect()
            ->route('admin-psdm.members.index')
            ->with('message', 'Member berhasil ditambahkan');
    }

    public function edit(Member $member)
    {
        return Inertia::render('admin-psdm/members/edit', [
            'member' => $member
        ]);
    }
