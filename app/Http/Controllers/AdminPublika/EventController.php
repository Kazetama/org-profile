...
use App\Http\Requests\AdminPublika\EventRequest;
...
class EventController extends Controller
{
    public function index(Request $request)
    {
        ...
        return inertia('admin-publika/event/index', [
            'events' => $events,
    ...
    {
        return inertia('admin-publika/event/create');
    }
    ...
    public function edit(int $id)
    {
        ...
        return inertia('admin-publika/event/edit', [
            'event' => $event
        ]);
    }
    ...
    public function store(EventRequest $request)
    {
        ...
        return redirect()
            ->route('admin-publika.event.index')
    ...
    public function participants(Event $event)
    {
        ...
        return Inertia::render('admin-publika/event/participants', [
            'event' => $event,
